...
export class GridStackEngine {
  ...
  protected collideCoverage(
    r: GridStackPosition,
    collides: GridStackNode[]
  ): { collide: GridStackNode; over: number } {
  ...
  public addNode(
    ...
    node = this._inColumnResize
      ? this.nodeBoundFix(node)
  ...
  public moveNodeCheck(node: GridStackNode, o: GridStackMoveOpts): boolean {
    ...
    let canMove =
      clone.moveNode(clonedNode, o) && clone.getRow() <= this.maxRow;
  ...
  public moveNode(node: GridStackNode, o: GridStackMoveOpts): boolean {
    ...
    if (collides.length) {
      ...
      let collide = activeDrag
        ? this.collideCoverage(o, collides).collide
        : collides[0];
